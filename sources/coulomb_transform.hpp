...
inline std::string get_M(const mrock::symbolic_operators::Momentum& k, const mrock::symbolic_operators::Momentum& q, bool conjugate, bool minus_at_0 = false) {
...
inline std::string get_alpha(const mrock::symbolic_operators::Momentum& k, const mrock::symbolic_operators::Momentum& q) {
	return ("\\alpha (" + k.to_string() + ", " + q.to_string() + ")");
}

inline std::string get_beta(const mrock::symbolic_operators::Momentum& k, const mrock::symbolic_operators::Momentum& q) {
	return ("\\alpha (" + (k + q).to_string() + ", " + (-q).to_string() + ")");
}

inline std::string get_coeff_A(const mrock::symbolic_operators::Momentum& k, const mrock::symbolic_operators::Momentum& q, bool minus_at_0 = false, bool conjugate = false) {
    std::string str = "\\sgn \\left[" + get_alpha(k, q) + "\\right] ";
    str += get_M(k, q, conjugate, minus_at_0);
    return str;
}

inline std::string get_coeff_B(const mrock::symbolic_operators::Momentum& k, const mrock::symbolic_operators::Momentum& q, bool minus_at_0 = false, bool conjugate = false) {
    std::string str = "\\sgn \\left[ " + get_beta(k, q) + " \\right] ";
    str += get_M(k + q, -q, !conjugate, minus_at_0);
    return str;
}

inline std::string get_C_1(const mrock::symbolic_operators::Momentum& k, const mrock::symbolic_operators::Momentum& l, 
                const mrock::symbolic_operators::Momentum& p, const mrock::symbolic_operators::Momentum& q, const std::string& between_summands = "\\\\\n\t\t&", bool conjugate = false) 
{
...
inline std::string get_C_2(const mrock::symbolic_operators::Momentum& k, const mrock::symbolic_operators::Momentum& l, 
                const mrock::symbolic_operators::Momentum& p, const mrock::symbolic_operators::Momentum& q, const std::string& between_summands = "\\\\\n\t\t&", bool conjugate = false) 
{
    std::string str = "+ V(" + k.to_string() + ", " + l.to_string() + ", " + q.to_string() + ") ";
